package com.erickvazquezs.hellomodulo4.practices.compose
...
fun FormComposable() {
    ...
    Box(modifier = Modifier.fillMaxSize().padding(20.dp), contentAlignment = Alignment.Center) {
        Card(modifier = Modifier.fillMaxSize(), elevation = CardDefaults.cardElevation(8.dp),
            ...
            LazyColumn(modifier = Modifier.fillMaxWidth().padding(15.dp),
                ...
                item {
                    Text(
                        "Formulario de registro", fontSize = 22.sp, fontWeight = FontWeight.Bold
                    )
                }
                ...
                item {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text("Acepto termino0s y condiciones")
                    }
                }

                item {
                    Button(onClick = {}, modifier = Modifier.fillMaxWidth(), enabled = isValid) {
                        Text("Siguiente")
                    }
                }
            }
